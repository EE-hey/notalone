defmodule NotaloneWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {NotaloneWeb.LayoutView, :root}
  ...
  scope "/room", NotaloneWeb do
    pipe_through [:browser, :user_has_access_to_room, :require_authenticated_user]
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: NotaloneWeb.Telemetry
    end
  end
